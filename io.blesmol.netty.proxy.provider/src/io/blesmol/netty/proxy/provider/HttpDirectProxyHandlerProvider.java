...
@Component(configurationPid = ProxyProviderApi.HttpDirectProxyHandler.PID, configurationPolicy = ConfigurationPolicy.REQUIRE, service = ChannelHandler.class)
...
//		ctx.pipeline().remove(ProxyProviderApi.HttpObjectAggegator.NAME);
...
//				ctx.pipeline().remove(ProxyProviderApi.HttpDirectProxyHandler.NAME);
